            ...
            >
              ...
              <div className="p-6 sm:p-8 flex flex-col justify-between flex-grow space-y-4">
                ...
                <div className="pt-4 border-t border-inherit flex items-center justify-between text-xs font-semibold uppercase tracking-wider">
                  <span className="group-hover:underline" style={{ color: gold }}>
                    Read Essay
                  </span>
      ...
      {selectedArticle && (
        ...
        >
          ...
          >
            <button
              onClick={() => setSelectedArticle(null)}
              className="absolute top-6 right-6 p-2 border border-inherit hover:opacity-60 cursor-pointer"
            >
              <X className="w-4 h-4" />
            </button>
            ...
            <div className="pt-6 border-t border-inherit flex items-center justify-between text-xs opacity-70">
              ...
              <button
                onClick={() => setSelectedArticle(null)}
                className="uppercase tracking-wider font-semibold hover:underline"
              >
                Close Essay &times;
              </button>
            </div>
